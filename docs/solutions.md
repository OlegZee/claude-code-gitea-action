      ...
      - uses: anthropics/claude-code-action@v1
        with:
          ...
          prompt: |
            ...
            Use `mcp__gitea__create_review_with_comments` to create reviews with inline comments.
            Only post Gitea comments - don't submit review text as messages.

          claude_args: |
            --allowedTools "mcp__gitea__create_review_with_comments,Bash(gh pr comment:*),Bash(gh pr diff:*),Bash(gh pr view:*)"
```
    ...
    steps:
      ...
      - uses: anthropics/claude-code-action@v1
        with:
          ...
          claude_args: |
            --allowedTools "mcp__gitea__create_review_with_comments,Bash(gh pr comment:*)"
```
    ...
    steps:
      ...
      - uses: anthropics/claude-code-action@v1
        with:
          ...
          claude_args: |
            --allowedTools "mcp__gitea__create_review_with_comments,Bash(gh pr comment:*),Bash(gh pr view:*)"
```
    ...
    steps:
      ...
      - uses: anthropics/claude-code-action@v1
        with:
          ...
          claude_args: |
            --allowedTools "mcp__gitea__create_review_with_comments,Bash(gh pr comment:*),Bash(gh pr diff:*)"
```
...
- **Inline Comments**: `mcp__gitea__create_review_with_comments`
